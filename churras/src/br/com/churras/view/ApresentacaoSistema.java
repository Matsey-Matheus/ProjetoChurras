...
public class ApresentacaoSistema {
	...
	public void apresentacao() {
		System.out.println("------------- APRESENTAÇÂO DO SISTEMA COMO USAR -------------");
		...
		System.out.println("------------- Valores por porção por pessoa -------------");
		System.out.println("450g de Picanha e de R$26,98");
		System.out.println("450g de Linguica R$ 17,46");
		System.out.println("Asa/Coxa R$ 6,00");
		System.out.println("Coca-Cola R$ 8,17");
		System.out.println("Heineken 5 latas R$ 32,95 (UNI R$ 6,59)");
		System.out.println("------------- ============================= -------------");
	}
